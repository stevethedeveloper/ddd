...
function parse_return($content)
{
	...
	$subscriptionId = substring_between($content,'<customerProfileId>','</customerProfileId>');
	$paymentprofileId = substring_between($content,'<customerPaymentProfileIdList><numericString>','</numericString></customerPaymentProfileIdList>');
	return array ($refId, $resultCode, $code, $text, $subscriptionId, $paymentprofileId);
}

function an_format_xml_create($loginname, $transactionkey, $refId, $email, $firstName, $lastName, $company, $cardNumber, $expirationDate, $mode = 'liveMode') {
	...
	$content =
		...
		<createCustomerProfileRequest xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">
			...
			<profile>
				<merchantCustomerId>'.$refId.'</merchantCustomerId>
				<email>'.$email.'</email>
				<paymentProfiles>
...
function an_format_xml_update($loginname, $transactionkey, $subscriptionId, $paymentprofileId, $cardNumber, $expirationDate, $amount = null) {
	...
	$content =
		...
		<updateCustomerPaymentProfileRequest xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">
			...
			<customerProfileId>'.$subscriptionId.'</customerProfileId>
			<paymentProfile>
				<payment>
					<creditCard>
						<cardNumber>'.$cardNumber.'</cardNumber>

...
?>
		<div id='main'>
			...
			<div id='maincontent'>
				<div id="left">
					<div align="center">
						<a href="http://twitter.com/DuckDuckDeal"><?=$html->image("follow_bird_us-a.png")?></a>
						<a href="http://www.facebook.com/DuckDuckDeal"><?=$html->image("findusonfacebook.gif")?></a>
					</div>
					<br clear="both" />
					<div class="title"></div>
					<br clear="both" />
					Click a listing to share, see details and a map directions.
					<br clear="both" />
					<br clear="both" />
					<?
				...
				<div id="right">
					...
					<br clear="both" />
					<br clear="both" />
					<div id="bottom_text"><strong>Next steps?</strong> <a href="<?=$html->url('/tour')?>">Tour the iPhone app</a> or see <a href="<?=$html->url('/price')?>">Pricing Plans</a> for merchants.</div>
					<br clear="both" />
					<br clear="both" />
				</div>
			</div>

...
?>
		<div id='main_no_hr'>
			<div id='maincontent'>
				...
				<div id="right">
					<?=$form->create('BusinessOffer', array('url' => '/manage/deals/add_everyday'))?>
					<h3 class="floatleft">Add Everyday Deal</h3><div class="form_note floatleft add_offer_note">Need help? <a href="#">Send us an email</a>.</div>
					<br clear="both" />

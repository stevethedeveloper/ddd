		...
		<div id='main_no_hr'>
			<div id='maincontent'>
				...
				<div id="right">
					...
					<div class="form_field"><?=$form->select('Business.previous', $deals, null, array('onChange' => 'window.location.href = \''.$html->url('/manage/deals/add/').'\'+this.value'), false)?></div>
					<br clear="both" />
					<br clear="both" />
					<?=$form->create('BusinessOffer', array('url' => '/manage/deals/add'))?>
					<h3 class="floatleft">Start a New Exploding Offer</h3><div class="form_note floatleft add_offer_note">Need help? <a href="mailto:contact@duckduckdeal.com ">Send us an email</a>.</div>
					<br clear="both" />
					...
					<br clear="both" />
					<div class="form_field left"><?=$form->input('dd_title', array('cols' => '65', 'rows' => '1', 'label' => '', 'onKeyDown' => 'limitText(this,this.form.countdown_span,30);', 'onKeyUp' => 'limitText(this,this.form.countdown_span,30);'))?></div>
					<br clear="both" />
					<br clear="both" />
					...
					<br clear="both" />
					<div class="form_field left"><?=$form->input('dd_description', array('cols' => '65', 'rows' => '1', 'label' => '', 'onKeyDown' => 'limitText2(this,this.form.countdown_span,100);', 'onKeyUp' => 'limitText2(this,this.form.countdown_span,100);'))?></div>
					<br clear="both" />
					<br clear="both" />
					...
					<div class="rounded_box_middle">
						<?
						e($form->month('dd_start', date('m'), array('id' => 'FieldId-mm'), false)." - ");
						e($form->day('dd_start', date('d'), array('id' => 'FieldId-dd'), false)." - ");
						e($form->year('dd_start', '1900', date('Y') + 50, date('Y'), array('id' => 'FieldId', 'class' => 'show-weeks dateformat-d-ds-m-ds-Y statusformat-l-cc-sp-d-sp-F-sp-Y highlight-days-67 split-date opacity-90'), false)); 
						?> 
						<br clear="both" />
